...
function analyzeSalesData(data, options) {
    ...
    if (!data 
        ...
        throw new Error("В опции передан не объект");
    }
    ...
    } else if (typeof calculateBonus !== "function" || typeof calculateRevenue !=="function") {
        throw new Error("В опции переданы не функции");
    }
